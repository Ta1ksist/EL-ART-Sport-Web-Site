...
export const PROJECTS: Project[] = [
  ...
  { 
    ...
    designPrinciple: "Архитектура — это про баланс масштаба, легкости и монументальности здания. Мы сочетаем открытые светлые объемы атриумов с жесткой геометрией брутального металла, чтобы задать пространству сильный характер и создать центральный скульптурный фокус, объединяющий уровни проекта. \nЭргономика — это про абсолютный комфорт человека и управление его вниманием через свет. Мы выстраиваем адаптивные световые сценарии и гибкое зонирование так, чтобы дневная инсоляция и вечерняя подсветка меняли пространство, бесшовно совмещая открытые хабы для мероприятий с уединенными локациями. \nКонцепция — это создание уникальной истории места через биофильный дизайн и фактуры. Мы интегрируем культурный код города, зеркальную гладь воды и благородный патинированный металл в чистый монохромный фон, превращая интерьер в осмысленную и премиальную среду.",
    area: "450 м²",
    timeline: "3 месяца",
  },
  { 
  ...
  { 
    ...
    area: "450 м²",
    timeline: "3 месяца",
    description1: "Цвет и освещение \nИнтуитивно понятные и психологически комфортные пространства, где дизайн следует за сценарием использования. Чем приватнее зона, тем более камерной и сфокусированной она становится.",
  },
  { 
  ...
  { 
    ...
    area: "2600 м²",
    timeline: "3 месяца",
    description1: "Экстерьер в интерьере: \nОтрывая дверь в падел клуб, мы попадаем в лето. \nЗдесь есть экстерьерная часть: бетонные скамейки и амфитеатры, растения и уличные светильники, второй свет дополняет эту атмосферу. А также есть “внутренние” пространства: кофейня, мерч, фитнесс, раздевалки. Они выделены подиумом и навесом.",
    description2: "Концепция 3 места: дом – работа - падел клуб \nПадел клуб - не только спорт. Это сообщество, место для отдыха, общения и объединения людей.",
  },
  { 
