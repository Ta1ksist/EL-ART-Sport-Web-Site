...
const TEAM: TeamMember[] = [
  ...
  { name: 'Герасимова Дарья', role: "Дизайнер", img: '' },
  { name: 'Фролова Елизавета', role: "Дизайнер-визуализатор", img: '' },
  { name: 'Попова Дарина', role: "Визуализатор", img: '' },
  { name: 'Хмара Елизавета', role: "Визуализатор", img: '' },
